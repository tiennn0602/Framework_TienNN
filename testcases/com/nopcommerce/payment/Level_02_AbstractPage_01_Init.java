...
public class Level_02_AbstractPage_01_Init {
	...
	public void TC_01_Register() {
		...
		abstractPage.sendKeytoElement("//input[@id='FirstName']", "Nguyen");

		// Enter Last Name
		//driver.findElement(By.xpath("//input[@id='LastName']")).sendKeys("Wick");
		abstractPage.sendKeytoElement("//input[@id='LastName']", "Tien");
		
		// Select DOB dropdown
		//select = new Select(driver.findElement(By.xpath("//select[@name='DateOfBirthDay']")));
		//select.selectByVisibleText("10");
		abstractPage.selectItemInDropdown("//select[@name='DateOfBirthDay']", "6");
		...
		abstractPage.selectItemInDropdown("//select[@name='DateOfBirthYear']", "1990");
		...
		abstractPage.sendKeytoElement("//input[@id='Company']", "Augen");

		// Enter Password and Confirm Password
		//driver.findElement(By.xpath("//input[@id='Password']")).sendKeys("123456");
		//driver.findElement(By.xpath("//input[@id='ConfirmPassword']")).sendKeys("123456");
		abstractPage.sendKeytoElement("//input[@id='Password']", "123456");
		abstractPage.sendKeytoElement("//input[@id='ConfirmPassword']", "123456");
